...
2. In the terminal window, run `bundle install`
3. Create a new directory at `mkdir spec/factories/` by running `mkdir spec/factories` in the terminal window. This is required by [factory_bot_rails](https://github.com/thoughtbot/factory_bot_rails#automatic-factory-definition-loading)
