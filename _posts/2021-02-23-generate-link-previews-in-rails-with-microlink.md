...
```javascript{5,13-32,34-38,40-45}
import { Controller } from "stimulus"
import mql from "@microlink/mql"
...
![handling errors.](/assets/images/posts/generate-link-previews-in-rails-with-microlink/handle-errors.gif)